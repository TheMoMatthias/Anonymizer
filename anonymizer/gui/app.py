...
# acts on. Anything else leaves the column to per-value review: "skip" (what the
# Columns panel writes today) and "none" (what an already-deployed config.yaml may
# still hold, from before the no-op word was unified across the screen).
